...
const WeatherAnalytics = () => {
  ...
  const charts: ChartItem[] = [
    { id: '1', title: 'Air Quality Index', subtitle: 'Pollutant Levels', type: 'bar', route: '/WeatherBarChartScreen' },
    { id: '2', title: 'Weather Trends', subtitle: 'Temperature & Conditions', type: 'line', route: '/WeatherLineChartScreen' },
    { id: '3', title: 'Weather Factors', subtitle: 'Distribution', type: 'pie', route: '/WeatherPieChartScreen' },
    { id: '4', title: 'Day vs Night', subtitle: 'Duration', type: 'donut', route: '/WeatherDonutChartScreen' },
    { id: '5', title: 'Wind Direction', subtitle: 'Speed by Direction', type: 'scatter', route: '/WeatherScatterChartScreen' },
    { id: '6', title: 'Pollutant Impact', subtitle: 'Bubble Analysis', type: 'bubble', route: '/WeatherBubbleChartScreen' },
    { id: '7', title: 'UV Index', subtitle: 'Exposure Level', type: 'gauge', route: '/WeatherGaugeChartScreen' },
  ];
